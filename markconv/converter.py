...
class MDConverter:
    ...
    def to_pdf(self, input_path: str, output_path: Optional[str] = None) -> None:
        """
        ...
        Args:
            input_path (str): 输入的 Markdown 文件路径
            output_path (Optional[str]): 输出的 PDF 文件路径
                如果为 None，则在输入文件同目录下生成同名 PDF 文件
        ...
        pdf_exporter = PDFExporter(css_file=self.html_exporter.css_file)
