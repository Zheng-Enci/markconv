...
setup(
    ...
    url='https://github.com/Zheng-Enci/mdtool',
    ...
    project_urls={
        # 问题反馈链接
        'Bug Reports': 'https://github.com/Zheng-Enci/mdtool/issues',
        
        # 源代码链接
        'Source': 'https://github.com/Zheng-Enci/mdtool',
        
        # 文档链接（指向 README.md）
        'Documentation': 'https://github.com/Zheng-Enci/mdtool/blob/master/README.md',
    },
)